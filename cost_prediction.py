...
Original file is located at
    https://colab.research.google.com/drive/1sYlhsj5edy3h0ip2biJh7piiPCUDvw2V
...
df = 0
trainfile = 'drive/MyDrive/data.csv' # replace this with https://health.data.ny.gov/api/views/4ny4-j5zv/rows.csv?accessType=DOWNLOAD
...
sns.kdeplot(x=pdf["Length of Stay"], y=pdf["Total Costs"], fill=True, cbar = True)
...
df.drop(['CCS Diagnosis Description','CCS Procedure Description','APR DRG Description','APR MDC Description','APR Severity of Illness Description', 'Total Charges'],axis=1,inplace=True)

df = df.dropna(subset=['Health Service Area','Hospital County','Operating Certificate Number', 'Facility Id','Zip Code - 3 digits', 'APR Risk of Mortality'])

columns_to_target_encode = ["Operating Certificate Number", 'CCS Procedure Code','CCS Diagnosis Code','Type of Admission', 'APR Risk of Mortality',
                            ...
                            "Health Service Area", "Hospital County", "Payment Typology 1", "Zip Code - 3 digits","APR DRG Code","APR MDC Code",
                            "Facility Name"]
